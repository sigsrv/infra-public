...
kubectl create ns --context sigsrv-sdlc chatgpt-discord-bot
...
kubectl apply --context sigsrv-sdlc -n chatgpt-discord-bot -f chatgpt-discord-bot-gpt-3.5-turbo.yaml
...
kubectl apply --context sigsrv-sdlc -n chatgpt-discord-bot -f chatgpt-discord-bot-gpt-4.yaml

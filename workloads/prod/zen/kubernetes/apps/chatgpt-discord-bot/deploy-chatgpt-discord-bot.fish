...
kubectl create ns --context k3s chatgpt-discord-bot

set OP_DISCORD_GPT_BOT_3_5_SECRET_PATH "$OP_DISCORD_GPT_BOT_ROOT_SECRET_PATH/chatgpt-discord-bot-secret-gpt-3.5-turbo"
kubectl create secret generic --context k3s -n chatgpt-discord-bot chatgpt-discord-bot-secret-gpt-3.5-turbo \
...
kubectl apply --context k3s -n chatgpt-discord-bot -f chatgpt-discord-bot-gpt-3.5-turbo.yaml

set OP_DISCORD_GPT_BOT_4_SECRET_PATH "$OP_DISCORD_GPT_BOT_ROOT_SECRET_PATH/chatgpt-discord-bot-secret-gpt-4"
kubectl create secret generic --context k3s -n chatgpt-discord-bot chatgpt-discord-bot-secret-gpt-4 \
...
kubectl apply --context k3s -n chatgpt-discord-bot -f chatgpt-discord-bot-gpt-4.yaml

guardrails = [
    {
        ...
        "behavior": "PROACTIVE",
        "implementationTypes": {"CloudFormation guard rule"},
        "services": {"Amazon API Gateway"},
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": [
                "AC-4(26)",
                "AU-10",
        ...
        "controlObjectives": {"Establish logging and monitoring"},
    ...
    },
    {
        ...
        "controlObjectives": {"Encrypt data at rest"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::ApiGatewayV2::Stage"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["AC-3", "CM-2", "CM-2(2)"],
            "PCI DSS version 3.2.1": ["7.1.1", "7.2.1", "7.2.2"],
        },
        "controlObjectives": {"Use strong authentication"},
    ...
    },
    {
        ...
        "frameworks": set(),
        "frameworksIds": {},
        "controlObjectives": {"Encrypt data in transit"},
        ...
        "resourceTypes": {"AWS::ApiGateway::DomainName"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "HIGH",
    },
    {
        ...
        "behavior": "DETECTIVE",
        "implementationTypes": {"AWS Config rule"},
        "services": {"Amazon API Gateway"},
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": [
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["2.3", "4.1", "8.2.1"],
        },
        "controlObjectives": {"Encrypt data in transit"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["6.6"],
        },
        "controlObjectives": {"Protect configurations", "Manage vulnerabilities"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::ApiGatewayV2::Route"},
        "controlOwner": "AWS Security Hub",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::Athena::WorkGroup"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["SC-7(11)", "SC-7(16)"],
            "PCI DSS version 3.2.1": ["1.2.1", "1.3", "1.3.2", "1.3.4", "1.3.7"],
        },
        "controlObjectives": {"Protect configurations"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["1.2.1", "1.3", "1.3.1", "1.3.2", "1.3.4"],
        },
        "controlObjectives": {"Protect configurations", "Enforce least privilege"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "controlObjectives": {"Manage vulnerabilities"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["CP-10", "SC-36", "SC-5(2)", "SI-13(5)"]
        },
        "controlObjectives": {"Improve availability"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["CA-9(1)", "CM-2"],
            "PCI DSS version 3.2.1": ["4.1"],
        },
        "controlObjectives": {"Improve availability", "Encrypt data in transit"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworks": set(),
        "frameworksIds": {},
        "controlObjectives": {"Enforce least privilege"},
        "releaseDate": "<UPDATE>",
    ...
    },
    {
        ...
        "controlObjectives": {"Limit network access"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["10.7", "3.1"],
        },
        "controlObjectives": {"Establish logging and monitoring"},
        "releaseDate": "2023-07-24",
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["AU-6(1)", "AU-6(5)", "CA-7", "SI-2", "SI-4(12)"]
        },
        "controlObjectives": {"Establish logging and monitoring"},
        "releaseDate": "2023-07-24",
    ...
    },
    {
        ...
        "behavior": "PREVENTIVE",
        "implementationTypes": {"Service control policy (SCP)"},
        "services": {"Amazon CloudWatch"},
        "frameworks": {"NIST 800-53 Rev 5"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["CM-2", "CM-2(2)", "CM-3", "CM-3(8)", "SA-8(19)"]
        },
        "controlObjectives": {"Protect configurations"},
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["3.4", "8.2.1"],
        },
        "controlObjectives": {"Encrypt data at rest"},
        "releaseDate": "2023-07-24",
        ...
        "resourceTypes": {"AWS::DocDB::DBCluster"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    {
        ...
        "controlObjectives": {"Improve resiliency"},
        "releaseDate": "2023-07-24",
    ...
    },
    {
        ...
        "frameworks": set(),
        "frameworksIds": {},
        "controlObjectives": {"Improve resiliency", "Improve availability"},
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["3.4", "3.5.3", "8.2.1"],
        },
        "controlObjectives": {"Encrypt data at rest"},
        "releaseDate": "2023-07-24",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::DynamoDB::Cluster"},
        "controlOwner": "AWS Security Hub",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    {
        ...
        "services": {"Amazon EC2"},
        "frameworks": {"NIST 800-53 Rev 5"},
        "frameworksIds": {"NIST 800-53 Rev 5": ["CP-10", "CP-9", "SC-5(2)"]},
        "controlObjectives": {"Improve availability"},
    ...
    },
    {
        ...
        "controlObjectives": {"Enforce least privilege", "Limit network access"},
    ...
    },
    {
        ...
        "services": {"Amazon EC2"},
        "frameworks": {"NIST 800-53 Rev 5"},
        "frameworksIds": {"NIST 800-53 Rev 5": ["CA-9(1)", "CM-2", "CM-2(2)"]},
        "controlObjectives": {"Optimize costs"},
        "releaseDate": "2019-07-30",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["2.2", "3.4", "8.2.1"],
        },
        "controlObjectives": {"Encrypt data at rest"},
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["1.2.1", "1.3", "1.3.2", "1.3.4", "2.2.2"],
        },
        "controlObjectives": {"Limit network access"},
        "releaseDate": "2021-11-30",
        ...
        "resourceTypes": {"AWS::EC2::RouteTable"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::EC2::LaunchTemplate"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "HIGH",
    },
    ...
    },
    {
        ...
        "services": {"Amazon EC2"},
        "frameworks": {"NIST 800-53 Rev 5"},
        "frameworksIds": {"NIST 800-53 Rev 5": ["CA-7", "SI-2"]},
        "controlObjectives": {"Establish logging and monitoring"},
        "releaseDate": "2023-07-24",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::EC2::SecurityGroupIngress", "AWS::EC2::SecurityGroup"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "HIGH",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::EC2::NetworkAclEntry"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["AC-4(21)", "CA-9(1)", "CM-2"],
            "PCI DSS version 3.2.1": ["1.2.1", "1.3", "1.3.2", "1.3.4"],
        },
        "controlObjectives": {"Limit network access"},
        "releaseDate": "2022-11-28",
        ...
        "resourceTypes": {"AWS::EC2::TransitGateway"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "HIGH",
    },
    {
        ...
        "resourceTypes": {"AWS::EC2::Volume", "AWS::EC2::Instance"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::EC2::ClientVpnEndpoint"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "implementationTypes": {"AWS Config rule"},
        "services": {"Amazon EC2"},
        "frameworks": {"PCI DSS version 3.2.1"},
        "frameworksIds": {"PCI DSS version 3.2.1": ["2.4"]},
        "controlObjectives": {"Protect configurations"},
        "releaseDate": "2022-11-28",
        ...
        "resourceTypes": {"AWS::EC2::NetworkAcl"},
        "controlOwner": "AWS Security Hub",
        "guidance": "Elective",
        "severity": "LOW",
    },
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["CM-8(1)"],
            "PCI DSS version 3.2.1": ["2.2", "2.4"],
        },
        "controlObjectives": {"Protect configurations", "Limit network access"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "controlObjectives": {"Protect configurations", "Optimize costs"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["CA-9(1)", "CM-2", "CM-2(2)"],
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["AC-3", "AC-3(15)", "AC-3(7)", "AC-6"],
            "PCI DSS version 3.2.1": ["7.1.1", "7.2.1", "7.2.2"],
        },
        "controlObjectives": {"Protect configurations"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["CA-7", "CP-2(2)", "SI-2"],
            "PCI DSS version 3.2.1": ["2.2"],
        },
        "controlObjectives": {"Improve availability"},
        "releaseDate": "2023-05-19",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["11.2.3", "6.3.2"],
        },
        "controlObjectives": {"Manage vulnerabilities"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["CA-9(1)", "CM-2", "CM-8(1)"],
            "PCI DSS version 3.2.1": ["2.2", "2.4"],
        },
        "controlObjectives": {"Protect configurations"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["SI-2", "SI-2(2)", "SI-2(4)", "SI-2(5)"],
            "PCI DSS version 3.2.1": ["6.2"],
        },
        "controlObjectives": {"Manage vulnerabilities"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["AU-6(3)", "AU-6(4)", "CA-7", "SI-2"],
            "PCI DSS version 3.2.1": [
                "10.1",
                "10.2.1",
                "10.2.2",
    ...
    },
    {
        ...
        "controlObjectives": {"Enforce least privilege", "Manage vulnerabilities"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["7.1.1", "7.1.2", "7.2.1", "7.2.2"],
        },
        "controlObjectives": {"Manage vulnerabilities"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::EFS::AccessPoint"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::ElastiCache::CacheCluster"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["AC-2(1)", "AC-3", "AC-3(15)", "AC-3(7)", "AC-6"],
            "PCI DSS version 3.2.1": ["7.1.1", "7.2.1", "7.2.2"],
        },
        "controlObjectives": {"Enforce least privilege"},
        "releaseDate": "2023-07-24",
    ...
    },
    {
        ...
        "controlObjectives": {"Prepare for disaster recovery"},
        "releaseDate": "<UPDATE>",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::EMR::SecurityConfiguration"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "CIS AWS Benchmark 1.4"},
        "frameworksIds": {
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["11.4"],
        },
        "controlObjectives": {"Prepare for incident response"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::AmazonMQ::Broker"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "CRITICAL",
    },
    {
        ...
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["AC-2(1)", "AC-3", "AC-3(15)", "AC-3(7)", "AC-6"],
            "PCI DSS version 3.2.1": ["7.1.1", "7.2.1", "7.2.2", "8.7"],
        },
        "controlObjectives": {"Use strong authentication", "Enforce least privilege"},
        "releaseDate": "2023-07-24",
        ...
        "resourceTypes": {"AWS::Neptune::DBCluster"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "HIGH",
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["CM-3", "SC-5(2)"],
            "PCI DSS version 3.2.1": ["2.2"],
        },
        "controlObjectives": {"Improve availability", "Protect configurations"},
        "releaseDate": "2023-07-24",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::RDS::DBClusterSnapshot"},
        "controlOwner": "AWS Security Hub",
        "guidance": "Elective",
        "severity": "CRITICAL",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::Elasticsearch::Domain"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::OpenSearchService::Domain"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "CRITICAL",
    },
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["CP-10", "CP-6(2)", "SC-36", "SC-5(2)", "SI-13(5)"]
        },
        "controlObjectives": {"Improve availability"},
        "releaseDate": "2023-05-19",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::OpenSearch::Domain"},
        "controlOwner": "AWS Security Hub",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::RDS::DBSnapshot"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Strongly-Recommended",
        "severity": "HIGH",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::RDS::EventSubscription"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "LOW",
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["CM-3", "SC-5(2)", "SI-13(5)"],
            "PCI DSS version 3.2.1": ["2.2"],
        },
        "controlObjectives": {"Improve availability"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::RDS::DBInstance", "AWS::RDS::DBSecurityGroup"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["1.2.1", "1.3.1", "1.3.2", "1.3.4", "2.2"],
        },
        "controlObjectives": {"Limit network access"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "controlObjectives": {"Protect data integrity", "Enforce least privilege"},
        "releaseDate": "2022-11-28",
        "description": "This AWS control checks if Amazon Relational Database Service (Amazon RDS) snapshots are public.",
        "resourceTypes": {"AWS::RDS::DBClusterSnapshot", "AWS::RDS::DBSnapshot"},
        "controlOwner": "AWS Security Hub",
        "guidance": "Elective",
        "severity": "CRITICAL",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::Redshift::ClusterParameterGroup"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::S3::AccountPublicAccessBlock"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "controlObjectives": {"Improve availability", "Optimize costs"},
        "releaseDate": "2019-07-30",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["10.5", "10.5.2", "3.4", "3.5.3", "8.2.1"],
        },
        "controlObjectives": {"Encrypt data at rest"},
        "releaseDate": "2023-07-24",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["10.5.3", "10.5.4", "10.7", "3.1"],
        },
        "controlObjectives": {"Improve availability", "Optimize costs"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "services": {"Amazon S3"},
        "frameworks": {"NIST 800-53 Rev 5"},
        "frameworksIds": {"NIST 800-53 Rev 5": ["CA-7", "SI-3(8)", "SI-4", "SI-4(4)"]},
        "controlObjectives": {"Establish logging and monitoring"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["AC-2(1)", "AC-3", "AC-3(15)", "AC-3(7)", "AC-6"],
            "PCI DSS version 3.2.1": ["7.1.1", "7.2.3"],
        },
        "controlObjectives": {"Enforce least privilege"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["10.5", "10.5.2", "2.2", "3.4", "8.2.1"],
        },
        "controlObjectives": {"Encrypt data at rest"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["2.2", "4.1", "8.2.1"],
        },
        "controlObjectives": {"Encrypt data in transit"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "services": {"Amazon S3"},
        "frameworks": {"NIST 800-53 Rev 5"},
        "frameworksIds": {"NIST 800-53 Rev 5": ["CP-6(2)"]},
        "controlObjectives": {"Protect data integrity"},
        "releaseDate": "2023-07-24",
    ...
    },
    {
        ...
        "services": {"Amazon S3"},
        "frameworks": {"NIST 800-53 Rev 5"},
        "frameworksIds": {"NIST 800-53 Rev 5": ["SI-12"]},
        "controlObjectives": {"Improve resiliency"},
        "releaseDate": "2019-04-30",
    ...
    },
    {
        ...
        "services": {"Amazon SNS"},
        "frameworks": {"PCI DSS version 3.2.1"},
        "frameworksIds": {"PCI DSS version 3.2.1": ["10.1"]},
        "controlObjectives": {"Establish logging and monitoring"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["CP-10", "CP-6(2)", "SC-36", "SC-5(2)", "SI-13(5)"],
            "PCI DSS version 3.2.1": ["1.2.1", "1.3.2"],
        },
        "controlObjectives": {"Improve availability"},
        "releaseDate": "2022-11-28",
        ...
        "resourceTypes": {"AWS::EC2::VPNConnection"},
        "controlOwner": "AWS Security Hub",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    {
        ...
        "behavior": "DETECTIVE",
        "implementationTypes": {"AWS Config rule"},
        "services": {"AWS Account Management"},
        "frameworks": {
            "NIST 800-53 Rev 5",
            "CIS AWS Benchmark 1.4",
            "PCI DSS version 3.2.1",
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["SC-28(3)", "SC-7(16)"],
            "PCI DSS version 3.2.1": ["4.1"],
        },
        "controlObjectives": {"Encrypt data in transit"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["SI-4(12)", "SI-4(5)"],
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["10.5", "10.5.2", "2.2", "3.4"],
        },
        "controlObjectives": {"Encrypt data at rest"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            "CIS AWS Benchmark 1.4": ["3.2"],
            "NIST 800-53 Rev 5": ["AU-9", "SI-4", "SI-7(1)", "SI-7(3)", "SI-7(7)"],
            "PCI DSS version 3.2.1": ["10.5.5", "11.5", "2.2"],
        },
        "controlObjectives": {"Protect data integrity"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["10.5.3", "10.5.4", "2.2"],
        },
        "controlObjectives": {"Establish logging and monitoring"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::CloudTrail::EventDataStore"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "LOW",
    },
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["10.1", "10.2.3", "10.2.6"],
        },
        "controlObjectives": {"Establish logging and monitoring"},
        "releaseDate": "2019-05-21",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["6.4.4", "8.2.1"],
        },
        "controlObjectives": {"Use strong authentication"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            "CIS AWS Benchmark 1.4": ["3.5"],
            "NIST 800-53 Rev 5": ["CM-3", "CM-6(1)", "CM-8", "CM-8(2)"],
            "PCI DSS version 3.2.1": ["11.5"],
        },
        "controlObjectives": {"Establish logging and monitoring"},
        "releaseDate": "2019-04-30",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::DMS::ReplicationInstance"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::ElasticBeanstalk::Environment"},
        "controlOwner": "AWS Security Hub",
        "guidance": "Elective",
        "severity": "LOW",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::Glue::SecurityConfiguration"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["8.3.1", "8.3.2", "8.6"],
        },
        "controlObjectives": {"Enforce least privilege"},
        "releaseDate": "2019-07-30",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["2.2", "8.3.1", "8.3.2", "8.6"],
        },
        "controlObjectives": {"Enforce least privilege"},
        "releaseDate": "2019-07-30",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["2.1", "2.2", "8.3.1", "8.3.2"],
        },
        "controlObjectives": {"Enforce least privilege"},
        "releaseDate": "2018-11-15",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["2.2", "7.1.1", "7.1.2", "7.2.1", "7.2.2"],
        },
        "controlObjectives": {"Enforce least privilege"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::IAM::ManagedPolicy"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "HIGH",
    },
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "NIST 800-53 Rev 5": ["AC-2(1)", "AC-2(3)", "AC-3(15)"],
            "PCI DSS version 3.2.1": ["2.2", "8.2.4"],
        },
        "controlObjectives": {"Enforce least privilege"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["2.2", "8.1.4"],
        },
        "controlObjectives": {"Enforce least privilege"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::IAM::AccessKey", "AWS::::Account"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Strongly-Recommended",
        "severity": "HIGH",
    },
    ...
    },
    {
        ...
        "frameworksIds": {
            "CIS AWS Benchmark 1.4": ["3.8"],
            "NIST 800-53 Rev 5": ["SC-12", "SC-12(2)", "SC-28(3)"],
            "PCI DSS version 3.2.1": ["2.2", "3.6.4"],
        },
        "controlObjectives": {"Encrypt data at rest"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworksIds": {
            ...
            "PCI DSS version 3.2.1": ["3.5.2", "7.1.1", "7.1.2", "7.2.1", "7.2.2"],
        },
        "controlObjectives": {"Enforce least privilege"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::IAM::Role", "AWS::IAM::Group", "AWS::IAM::User"},
        "controlOwner": "AWS Security Hub",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::Lambda::LayerVersionPermission"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "CRITICAL",
    },
    ...
    },
    {
        ...
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["CA-9(1)", "CM-2"],
            "PCI DSS version 3.2.1": ["1.3.6", "11.4"],
        },
        "controlObjectives": {"Limit network access"},
        "releaseDate": "2022-11-28",
        ...
        "resourceTypes": {"AWS::NetworkFirewall::FirewallPolicy"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::NetworkFirewall::RuleGroup"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["AC-2(1)", "AC-3(15)"],
            "PCI DSS version 3.2.1": ["8.2.4"],
        },
        "controlObjectives": {"Manage secrets"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::SSM::Document"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "services": {"AWS Systems Manager"},
        "frameworks": {"PCI DSS version 3.2.1"},
        "frameworksIds": {"PCI DSS version 3.2.1": ["2.2", "6.2"]},
        "controlObjectives": {"Manage vulnerabilities"},
        "releaseDate": "2022-11-28",
        ...
        "resourceTypes": {"AWS::SSM::PatchCompliance"},
        "controlOwner": "AWS Security Hub",
        "guidance": "Elective",
        "severity": "HIGH",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::WAFRegional::Rule"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    {
        ...
        "resourceTypes": {"AWS::WAFRegional::WebACL"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::WAFv2::RuleGroup"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::WAFRegional::RuleGroup"},
        "controlOwner": "AWS Security Hub",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::WAF::RuleGroup"},
        "controlOwner": "AWS Security Hub",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "services": {"Elastic Load Balancing"},
        "frameworks": {"NIST 800-53 Rev 5"},
        "frameworksIds": {"NIST 800-53 Rev 5": ["CA-9(1)", "CM-2"]},
        "controlObjectives": {"Improve resiliency"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "resourceTypes": {"AWS::ElasticLoadBalancingV2::TargetGroup"},
        "controlOwner": "AWS Control Tower",
        "guidance": "Elective",
        "severity": "MEDIUM",
    },
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["SC-7(4)", "SC-8(2)"],
            "PCI DSS version 3.2.1": ["1.2.1", "1.3", "1.3.1", "1.3.2", "1.3.4"],
        },
        "controlObjectives": {"Protect configurations"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "frameworks": {"NIST 800-53 Rev 5", "PCI DSS version 3.2.1"},
        "frameworksIds": {
            "NIST 800-53 Rev 5": ["CA-9(1)", "CM-2", "CM-2(2)", "CM-3", "SC-5(2)"],
            "PCI DSS version 3.2.1": ["2.2"],
        },
        "controlObjectives": {"Improve availability"},
        "releaseDate": "2022-11-28",
    ...
    },
    {
        ...
        "behavior": "PREVENTIVE",
        "implementationTypes": {"Service control policy (SCP)"},
        "services": {"Amazon EC2", "Amazon CloudFront", "AWS Global Accelerator"},
        "frameworks": set(),
        "frameworksIds": {},
        "controlObjectives": {"Limit network access"},
        "releaseDate": "2021-11-30",
